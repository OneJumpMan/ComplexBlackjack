...
open class Player(val name : String) {
    ...
    fun countHand() : Double {
        ...
        // So, how do we choose?
        // Well, basically, in order to maximize the absolute total, we want to give the current largest dimension the first chance for its aces to be counted as 11.
        ...
        // This for loop takes care of adding the aces to the biggest dimension
        for (card in aces) {
        ...
        // And this for loop takes care of adding the aces to the smaller dimension
        for (card in aces) {
            if (card.suit in biggestDimension) { }
            else {
